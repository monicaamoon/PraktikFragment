package com.example.a18620127_praktikfragment;
...
public class CategoryFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_sub_category){
            ...
            mBundle.putString(DetailCategoryFragment.EXTRA_NAME, "ini di kirim dengan bundle");
            String description = "Ini di kirim dengan getter setter";
